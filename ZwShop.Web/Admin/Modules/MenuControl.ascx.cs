...
namespace ZwShop.Web.Admin.Modules
{
    public partial class MenuControl : BaseShopAdminUserControl
    {
        #region Handlers
        ...
        private void BuildMenuRecursive(StringBuilder sb, SiteMapNode node)
        {
            ...
            string title = HttpUtility.HtmlEncode(node.Title);
            string descr = HttpUtility.HtmlEncode(node.Description);
