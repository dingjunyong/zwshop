                            ...
                            if (int.TryParse(valueStr, out pvaId))
                            {
                                ...
                                if (pvaValue != null)
                                {
                                    ...
                                    if (renderPrices)
                                    {
                                        ...
                                        decimal priceAdjustment = IoC.Resolve<ICurrencyService>().ConvertCurrency(priceAdjustmentBase, IoC.Resolve<ICurrencyService>().PrimaryStoreCurrency, ShopContext.Current.WorkingCurrency);
