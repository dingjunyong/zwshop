...
namespace ZwShop.Services.Products.Attributes
{
    ...
    {
        #region Constants
        private const string CHECKOUTATTRIBUTES_ALL_KEY = "Shop.checkoutattribute.all-{0}";
        private const string CHECKOUTATTRIBUTES_BY_ID_KEY = "Shop.checkoutattribute.id-{0}";
        private const string CHECKOUTATTRIBUTEVALUES_ALL_KEY = "Shop.checkoutattributevalue.all-{0}";
        private const string CHECKOUTATTRIBUTEVALUES_BY_ID_KEY = "Shop.checkoutattributevalue.id-{0}";
        private const string CHECKOUTATTRIBUTES_PATTERN_KEY = "Shop.checkoutattribute.";
        private const string CHECKOUTATTRIBUTEVALUES_PATTERN_KEY = "Shop.checkoutattributevalue.";
        #endregion
        ...
        public CheckoutAttributeService(ShopObjectContext context)
        {
