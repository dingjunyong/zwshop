...
namespace ZwShop.Services.Products
{
    ...
    public partial class PriceHelper
    {
        ...
        protected static string GetCurrencyString(decimal amount)
        {
            ...
            var targetCurrency = ShopContext.Current.WorkingCurrency;
        ...
        {
            var customer = ShopContext.Current.User;
        ...
        {
            var language = ShopContext.Current.WorkingLanguage;
            bool priceIncludesTax = false;
            switch (ShopContext.Current.TaxDisplayType)
            {
