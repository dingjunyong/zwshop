...
using ZwShop.Services.Templates;
using ZwShop.Common;
...
namespace ZwShop.Services.Products
{
    ...
    public partial class Product : BaseEntity
    {
        ...
        public string LocalizedShortDescription
        {
            get
            {
                return GetLocalizedShortDescription(ShopContext.Current.WorkingLanguage.LanguageId);
            }
        }
        ...
        public string LocalizedFullDescription
        {
            get
            {
                return GetLocalizedFullDescription(ShopContext.Current.WorkingLanguage.LanguageId);
            }
        }
        ...
        public string LocalizedMetaKeywords
        {
            get
            {
                return GetLocalizedMetaKeywords(ShopContext.Current.WorkingLanguage.LanguageId);
            }
        }
        ...
        public string LocalizedMetaDescription
        {
            get
            {
                return GetLocalizedMetaDescription(ShopContext.Current.WorkingLanguage.LanguageId);
            }
        }
        ...
        public string LocalizedMetaTitle
        {
            get
            {
                return GetLocalizedMetaTitle(ShopContext.Current.WorkingLanguage.LanguageId);
            }
        }
        ...
        public string LocalizedSEName
        {
            get
            {
                return GetLocalizedSEName(ShopContext.Current.WorkingLanguage.LanguageId);
            }
        }
        ...
        public ProductTemplate ProductTemplate
        {
            get
            {
                return IoC.Resolve<ITemplateService>().GetProductTemplateById(this.TemplateId);
            }
        }
        ...
        public List<RelatedProduct> RelatedProducts
        {
            get
            {
                return IoC.Resolve<IProductService>().GetRelatedProductsByProductId1(this.ProductId);
            }
        }
        ...
        public List<CrossSellProduct> CrossSellProducts
        {
            get
            {
                return IoC.Resolve<IProductService>().GetCrossSellProductsByProductId1(this.ProductId);
            }
        }
        ...
        public Picture DefaultPicture
        {
            get
            {
                var picture = IoC.Resolve<IPictureService>().GetPicturesByProductId(this.ProductId, 1).FirstOrDefault();
                return picture;
            }
        }
        ...
        public List<ProductPicture> ProductPictures
        {
            get
            {
                return IoC.Resolve<IProductService>().GetProductPicturesByProductId(this.ProductId);
            }
        }
        ...
        public List<ProductCategory> ProductCategories
        {
            get
            {
                return IoC.Resolve<ICategoryService>().GetProductCategoriesByProductId(this.ProductId);
            }
        }
        ...
        public List<ProductBrand> ProductBrands
        {
            get
            {
                return IoC.Resolve<IBrandService>().GetProductBrandsByProductId(this.ProductId);
            }
        }
        ...
        public List<ProductReview> ProductReviews
        {
            get
            {
                return IoC.Resolve<IProductService>().GetProductReviewByProductId(this.ProductId);
            }
        }
        ...
        /// Gets the product Brands
        /// </summary>
        public virtual ICollection<ProductBrand> NpProductBrands { get; set; }
