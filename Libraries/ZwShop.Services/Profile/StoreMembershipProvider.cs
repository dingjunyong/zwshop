...
{
    /// <summary>
    /// Manages storage of membership information for a ShopCommerce application in a data source
    /// </summary>
    public partial class StoreMembershipProvider : MembershipProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (string.IsNullOrEmpty(config["description"]))
            {
                ...
                config.Add("description", "Membership Provider for ShopCommerce");
            }
            ...
            {
                this._appName = "ShopSqlConnection";
            }
